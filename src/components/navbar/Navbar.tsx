...
const komiteler = [
  {
    name: "Komite1",
    description: "",
    href: "/komiteler/komite1",
    icon: ChevronDoubleRightIcon,
  },
  {
    name: "Komite2",
    description: "",
    href: "/komiteler/komite2",
    icon: ChevronDoubleRightIcon,
  },
  {
    name: "Komite3",
    description: "",
    href: "/komiteler/komite3",
    icon: ChevronDoubleRightIcon,
  },
];
...
const calistay = [
  {
    ...
    description: "",
    href: "/calistay/yapay-zeka-ve-robotlar",
    icon: FaBrain,
  },
  {
  ...
  },
  {
    ...
    description: "",
    href: "/calistay/medikal-yapay-zeka",
    icon: FaLaptopMedical,
  },
  {
    name: "Metaverse ve Konferans",
    description: "",
    href: "/calistay/metaverse-ve-konferans",
    icon: FaMeta,
  },
];
  ...
  return (
    <header className="bg-base-100 sticky top-0 z-50 ">
      ...
      >
        <div>
          <a href="/">
            ...
            <Image
              ...
              width={250}
              height={70}
              className="cursor-pointeractive:scale-95 transition-transform w-[150px] lg:w-[250px]"
              alt="tuyafed-logo"
            />
          </a>
        </div>
        ...
        <Popover.Group className="hidden lg:flex lg:gap-x-4 xl:gap-x-8 w-full mx-4 items-center justify-center">
          ...
          <a href="/faaliyetler" className="text-sm font-semibold leading-6">
            Faaliyetler
          </a>
        </Popover.Group>
        <a
